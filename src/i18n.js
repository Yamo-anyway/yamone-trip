export const dictionaries = {
  ko: {
    ...
    invalidSchedule:'여행 기간 내 날짜와 시각을 확인해 주세요. 경험은 1분 이상, 이동·휴식은 0분 이상 정수이며 전체 일정은 자정을 넘길 수 없습니다.', invalidUnitDraft:'원문 언어, 제목, 설명, 장소, 시간, 비용과 1–5개 경험 포인트를 확인해 주세요.', invalidImprovement:'개선 제안은 1,000자 이내로 구체적으로 작성해 주세요.', invalidLineage:'원작 유닛과 버전 출처를 확인할 수 없습니다.', invalidTranslation:'제목, 설명, 장소와 모든 경험 포인트의 번역을 확인해 주세요.',
