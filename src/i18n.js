export const dictionaries = {
  ko: {
    ...
    invalidSchedule:'여행 기간 내 날짜와 시각을 확인해 주세요. 경험은 1분 이상, 이동·휴식은 0분 이상 정수이며 전체 일정은 자정을 넘길 수 없습니다.',
  ...
  en: {
    ...
    invalidSchedule:'Use a date within the trip and a valid time. Experience time must be a positive whole number; travel/break must be nonnegative whole numbers. The total cannot cross midnight.',
