...
**v0.8.0 · Android 네이티브 로컬 번역 변형·검토 상태 단계. APK는 아직 생성·검증하지 못했습니다.**
...
다음 실행도 먼저 **A03: 로컬 Android APK 빌드 및 실제 기기 스모크 검사** 가능 여부를 확인합니다. 빌드 도구가 계속 없으면 제한을 유지하고 **M07: 실제 호출이 차단된 API mock 하네스와 저장소 경계**를 진행합니다. [AGENTS.md](AGENTS.md), [제품 범위](docs/PRODUCT.md), [진행 기록](docs/PROGRESS.md), [API 계약](docs/API_CONTRACT.md)을 최신 main에서 읽고 계속합니다.
