...
**v0.9.0 · Android 네이티브 API mock·저장소 경계 단계. 실제 API와 APK는 아직 연결·생성·검증하지 못했습니다.**
...
다음 실행도 먼저 **A03: 로컬 Android APK 빌드 및 실제 기기 스모크 검사** 가능 여부를 확인합니다. 빌드 도구가 계속 없으면 제한을 유지하고 **M09: 네이티브 접근성·데이터 손실 회귀 검사**를 진행합니다. [AGENTS.md](AGENTS.md), [제품 범위](docs/PRODUCT.md), [진행 기록](docs/PROGRESS.md), [API 계약](docs/API_CONTRACT.md)을 최신 main에서 읽고 계속합니다.
